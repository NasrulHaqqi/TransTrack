    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="vehicle.php">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="
              ...
              border-bottom
            ">
          <h1 class="h2">Vehicle Information</h1>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            <thead>
              <tr>
                <th class="col-1">#</th>
                <th class="col-2">No Kendaraan</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalFormCenterTitle">Add Vehicle</h5>
        ...
        <div class="modal-body mb-3">
          <form>
            <div class="form-group">
              <label for="no" class="col-form-label">No Kendaraan:</label>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="tahun" name="tahun"></input>
            </div>
          </form>
        </div>
